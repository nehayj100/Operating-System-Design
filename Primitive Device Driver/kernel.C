...
void fun2()
{
    ...
    for (int j = 0;; j++)
    {
        ...
        /* -- Read */
        Console::puts("Reading a block from disk in fun 2...\n");
        SYSTEM_DISK->read(read_block, buf);

        //Console::puts("Now READING in FUN2...........\n");
        /* -- Display */
        int i;
...
void fun3()
{
    ...
    for (int j = 0;; j++)
    {
        ...
        Console::puts("FUN 3 IN ITERATION[");
        Console::puti(j);
        Console::puts("]\n");

        /* -- Read */
        Console::puts("Reading a block from disk in fun3 ...\n");
        SYSTEM_DISK->read(read_block, buf);
        //Console::puts("Now READING in FUN3...........\n");
        /* -- Display */
        int i;
        for (i = 0; i < DISK_BLOCK_SIZE; i++)
        {
...
int main()
{
    ...
    class NULL_Handler : public InterruptHandler
    {
    public:
