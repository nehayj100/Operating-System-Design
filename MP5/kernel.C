...
// now we check if RR scheduler is defined- if yes point to that else FIFO is used
#ifdef _RR_SCHEDULER_
RoundRobinScheduler *SYSTEM_SCHEDULER;
#else
...
int main() {
    ...
    //Console::puts("before thread 2 addition\n");
